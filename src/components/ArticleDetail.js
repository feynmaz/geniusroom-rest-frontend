...
export const ArticleDetail = ({ id }) => {
    ...
    useEffect(() => {
        async function fetchData() {
            ...
            setComments(dataArticle['comments'])
            setIsLoading(false)
        }
        fetchData()
    }, [access])
    ...
    return (
        isLoading ?
            ...
            <div className={'article'}>
                ...
                <Rating articleId={id} rating={rating} setRating={setRating} setIsLoading={setIsLoading} />

                <AdditionalImages data={ais} />

                <Comments data={comments} articleId={id} />
